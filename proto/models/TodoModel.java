...
public final class TodoModel {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return models.TodoModel.internal_static_todo_Todo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return models.TodoModel.internal_static_todo_Todo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              models.TodoModel.Todo.class, models.TodoModel.Todo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof models.TodoModel.Todo)) {
        return super.equals(obj);
      }
      models.TodoModel.Todo other = (models.TodoModel.Todo) obj;
    ...
    public static models.TodoModel.Todo parseFrom(
    ...
    public static models.TodoModel.Todo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static models.TodoModel.Todo parseFrom(
    ...
    public static models.TodoModel.Todo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static models.TodoModel.Todo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static models.TodoModel.Todo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(models.TodoModel.Todo prototype) {
    ...
    public static final class Builder extends
        ...
        models.TodoModel.TodoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return models.TodoModel.internal_static_todo_Todo_descriptor;
      }
      ...
      // Construct using models.TodoModel.Todo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public models.TodoModel.Todo getDefaultInstanceForType() {
        return models.TodoModel.Todo.getDefaultInstance();
      }

      @java.lang.Override
      public models.TodoModel.Todo build() {
        models.TodoModel.Todo result = buildPartial();
      ...
      @java.lang.Override
      public models.TodoModel.Todo buildPartial() {
        models.TodoModel.Todo result = new models.TodoModel.Todo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof models.TodoModel.Todo) {
          return mergeFrom((models.TodoModel.Todo)other);
        } else {
      ...
      public Builder mergeFrom(models.TodoModel.Todo other) {
        if (other == models.TodoModel.Todo.getDefaultInstance()) return this;
        if (other.hasTid()) {
          setTid(other.getTid());
        }
        if (other.hasTitle()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        models.TodoModel.Todo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (models.TodoModel.Todo) e.getUnfinishedMessage();
  ...
  bitField0_ |= 0x00000008;
    ...
    private static final models.TodoModel.Todo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new models.TodoModel.Todo();
    }

    public static models.TodoModel.Todo getDefaultInstance() {
